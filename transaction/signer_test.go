...
func TestSignPsbtTx(t *testing.T) {
	...
	signedPacket, err := SignTx(c.GetParams(), packet, utils.MustDecode("1790962db820729606cd7b255ace1ac5ebb129ac8e9b2d8534d022194ab25b37"))
	require.NoError(t, err)
	rawTx, err := types.EncodePsbtToRawTx(signedPacket)
	require.NoError(t, err)
	rawTxString := utils.Encode(rawTx)
	...
	rawTxMake, err := types.DecodeRawTx(utils.MustDecode(rawTxString))
	require.NoError(t, err)
	rawTxInput, err := types.DecodeRawTx(utils.MustDecode(""))
	require.NoError(t, err)
